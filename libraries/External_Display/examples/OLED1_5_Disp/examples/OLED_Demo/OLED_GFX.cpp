...
void OLED_GFX::print_String(uint8_t x, uint8_t y,  uint8_t *text, FONT_SIZE size) {
...
void OLED_GFX::Display_String_8x16(uint8_t x, uint8_t y,  uint8_t *text) {
...
void OLED_GFX::Display_String_5x8(uint8_t x, uint8_t y,  uint8_t *text)  {
