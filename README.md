...
The recommended Carduino bootloader is based on the Arduino [Megacore bootloader](https://github.com/MCUdude/MegaCore), and that Bootloader is based on the Arduino [Optiboot Bootloader](https://github.com/Optiboot/optiboot)
